...
export const HelpBox: React.FC = () => {
  ...
  const applicationName = 'radical-football66';
...
2. As a Player, I want to be able to view and complete assigned training plans, so I can improve my skills and performance.
3. As a Player, I want to be able to communicate with my coach and teammates through the platform, so I can stay informed about team updates and events.
...
2. As a Parent, I want to be able to communicate with my child's coach through the platform, so I can stay informed about their progress and address any concerns.
3. As a Parent, I want to be able to view my child's team schedule, so I can stay up-to-date on practices, games, and other events.`;
